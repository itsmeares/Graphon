...
const VIEW_ORDER = ['table', 'board', 'gallery', 'list', 'chart', 'timeline', 'feed', 'map', 'calendar', 'form']
      ...
      {VIEW_ORDER.map((type) => {
        ...
        return (
          <button
            ...
            disabled={!view}
          >
            <Icon className={`w-4 h-4 ${isActive ? 'text-graphon-text-main dark:text-white' : 'text-graphon-text-secondary/70 dark:text-[#9b9b9b]/70 group-hover:text-graphon-text-main dark:group-hover:text-[#dfdfdf]'}`} />
